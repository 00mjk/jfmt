...
public class RgbText extends RgbColor {
    ...
    public RgbText(@NotNull int red, @NotNull int green, @NotNull int blue) {
    ...
    public static String random(@NotNull String text) {
        if(text == null) return "";
        Random r = new Random();
        RgbText rgb = new RgbText(255, 255, 255);
        rgb.red = r.nextInt(255);
        rgb.green = r.nextInt(255);
        rgb.blue = r.nextInt(255);
        rgb.result = "\u001b[38;2;"+rgb.red+";"+rgb.green+";"+rgb.blue+"m";
    ...
    public static String rainbow(@NotNull String text) {
        ...
        for(int i = 0; i < text.length(); i++) {
            ...
            rgb.green = r.nextInt(255);
            rgb.blue = r.nextInt(255);
            sb.append("\u001b[38;2;").append(rgb.red).append(";").append(rgb.green).append(";").append(rgb.blue).append("m").append(text.charAt(i));
        }
